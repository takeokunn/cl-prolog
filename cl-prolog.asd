(asdf:defsystem #:cl-prolog
  ...
  :pathname "src"
  :serial t
  :components ((:file "package") (:file "operator-table") (:file "module-system") (:file "data") (:file "unification") (:file "parser") (:file "parser-source") (:file "term-writer") (:file "engine") (:file "io-context") (:file "prover-state") (:file "prover") (:module "builtins" :serial t :components ((:file "core") (:file "control") (:file "collection") (:file "dynamic") (:file "arithmetic") (:file "list") (:file "atom") (:file "operator") (:file "io") (:file "io-streams") (:file "io-code"))) (:file "fd-store") (:file "builtins/fd") (:file "term-order") (:file "builtin-term") (:file "dcg-runtime") (:file "query") (:file "source-loader") (:file "source-loader-builtins") (:file "dsl-compiler") (:file "dsl") (:file "dcg"))
