...
(deftest-table rulebase-default-constructors ()
  (:equal '() (fact-args (make-fact :predicate 'lonely)))
  (:equal '() (rule-head (make-rule)))
  (:equal '() (rule-body (make-rule)))
  (:equal '() (rulebase-facts (make-rulebase)))
  (:equal '() (rulebase-rules (make-rulebase))))
