(
 ...
 ((:name "CL-PROLOG"
   ...
   :exports ("!" "!=" "#<" "#=" "#=<" "#>" "#>=" "#\\="
             ...
             "ASSERTA" "ASSERTZ" "ATOM" "ATOMIC" "BAGOF" "CALL"
             "CALL-CLEANUP" "CALLABLE" "CATCH" "CLAUSE" "CLAUSE-BODY"
             "CLAUSE-HEAD" "CLAUSE-P" "COMPARE" "COMPOUND" "CONSULT-PROLOG"
             "COPY_TERM" "CURRENT-PREDICATE" "DCG-ALT" "DCG-ERROR-RECOVERY"
             "DCG-OPT" "DCG-PLUS" "DCG-STAR" "DCG-TOKEN-MATCH"
             "DCG-TOKEN-MATCH-VALUE" "DEF-DCG-RULE" "DEF-RULE"
             "DEFINE-FOREIGN-PREDICATE" "DEFINE-RULEBASE" "EXTEND-RULEBASE"
             "FAIL" "FALSE" "FINDALL" "FLOAT" "FORALL"
             "FRESH-LOGIC-VARIABLE" "FUNCTOR" "GROUND" "IF-THEN-ELSE"
             "IN" "INTEGER" "INVALID-GOAL-ERROR" "INVALID-GOAL-ERROR-GOAL"
             "INVALID-MAX-DEPTH-ERROR" "INVALID-MAX-DEPTH-ERROR-VALUE" "IS"
             "KEYSORT" "LABELING" "LOGIC-SUBSTITUTE" "LOGIC-VAR-P" "MAKE-CLAUSE" "MAKE-RULEBASE"
             "MAP-PROLOG-SOLUTIONS" "NONVAR" "NUMBER" "NUMBERVARS" "ONCE"
             "PARSE-PROLOG" "PHRASE" "PHRASE-ALL" "PROLOG"
             "PROLOG-DEPTH-LIMIT-EXCEEDED" "PROLOG-DEPTH-LIMIT-EXCEEDED-GOAL"
             "PROLOG-DOMAIN-ERROR" "PROLOG-EVALUATION-ERROR" "PROLOG-EXCEPTION"
             ...
             "RULEBASE-VISIBLE-CLAUSES" "SETOF" "SETUP-CALL-CLEANUP" "SORT"
             "SOFT-IF-THEN-ELSE" "SOLUTION-BINDING" "TERM_VARIABLES" "THROW"
             "TRUE" "UNIFY" "UNIFY_WITH_OCCURS_CHECK" "VAR"
